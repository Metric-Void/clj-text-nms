...
(def available-topics ["mine" "explore" "base" "fly" "craft" "recharge"])
...
"Build a base at the current tile. You'll be able to teleport to your bases from anywhere in the universe, and your life support will slowly charge when you're at a base tile."
    :fly
"If you're in the same tile with your starship, you can fly to a random tile on a random planet."
    :craft
"Items can be crafted into other items. Use craft to list all the items you can make."
    :recharge
